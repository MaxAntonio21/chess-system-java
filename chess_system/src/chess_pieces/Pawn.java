    ...
    public boolean[][] possibleMoves() {
        ...
        if(getColor() == Color.WHITE){
            ...
            if(position.getRow() == 3 ){
                ...
                if(getbBoard().positionExists(left) && isThereOpponentPiece(left) && getbBoard().piece(left) == chessMatch.getEnPassantVulnerable()){
                    mat[left.getRow() - 1][left.getColumn()] = true;
                }
                Position right = new Position(position.getRow(), position.getColumn() + 1);
                if(getbBoard().positionExists(right) && isThereOpponentPiece(right) && getbBoard().piece(right) == chessMatch.getEnPassantVulnerable()){
